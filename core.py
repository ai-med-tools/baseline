...
sio.register_namespace(BaselineNamespace('/baselineqkswxttralls'))
...
def native_baseline_queue():
    ...
    while True:
        ...
        if msg["op"] == "start":
            ...
            sio.emit('session-start', msg["data"], "/baselineqkswxttralls")
...
if __name__ == "__main__":
    ...
    with daemon.DaemonContext():
        ...
        sio.connect(f'{perfomance["aimed_host"]}?token={perfomance["token"]}', namespaces=['/baselineqkswxttralls'], transports=['websocket'])
