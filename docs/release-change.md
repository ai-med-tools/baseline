...
## Фидбек
- команда ```send``` теперь в явном виде выводит в консоль результат своей работы (принят ли файл с решением платформой)
- **получение** файла на стороне Baseline теперь дополнительно пишет информацию в лог в сообщает платформе о том, принят ли файл с заданием и во сколько принят.
